      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-balance">
            ...
            <span className="block text-primary mt-2">du Saguenay—Lac-St-Jean</span>
          </h1>

          <p className="text-xl md:text-2xl text-foreground/80 mb-8 text-pretty leading-relaxed">
            Une communauté bénévole réunissant professionnels et amateurs passionnés de technologies numériques.
            Rencontres mensuelles gratuites en formule 5 à 7.
          </p>
